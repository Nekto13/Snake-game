...
public class GameSnake{
	...
	final String TITLE_OF_PROGRAM = "SupperSnake";
	final String GAME_OVER_MEG = "Game Over!";
	...
	public class Canvas extends JPanel{
		...
		public void paint(Graphics g){
			...
			if (gameOver) {
                ...
                g.drawString(GAME_OVER_MEG, (FIELD_WIDTH * POINT_RADIUS + FIELD_DX - fm.stringWidth(GAME_OVER_MEG))/2, (FIELD_HEIGHT * POINT_RADIUS + FIELD_DY)/2);
            }
		}
	}
}
